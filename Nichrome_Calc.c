...
int main(void) {
	...
	double Q1 = 30 * 2.15 * Td1 + 30 * 210; // 30 is the approximate weight of the wax in g. 2.14 is the specific heat of the wax in J/g-K. 210 is the latent heat of the wax in J/g.
