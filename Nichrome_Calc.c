...
int main(void) {
	...
	double Q1 = 30 * 2.15 * Td1 * 10 + 30 * 210; // 30 is the approximate weight of the wax in g. 2.14 is the specific heat of the wax in J/g-K. 210 is the latent heat of the wax in J/g. Through integration, the constant multiplier is 10.
	...
	double t1 = t; // t is the time required to reach the required tempeture.
	double Td2 = (Q1 / (kc * A1 * t1)); // kw is the thermal conductivity of the wax in W/m-K. A is the effective area of contact surface. Td2 is the difference in temperature between the wax and the spoon. t is the time required to reach the required tempeture.
	...
	double t2 = t; // t is the time required to reach the required tempeture.
	double Td3 = (Q2 / (kc * A2 * t2)); // kn is the thermal conductivity of the nichrome wire in W/m-K. A is the effective area of contact surface. Td2 is the difference in temperature between the stainless steel spoon and the nichrome wire. t is the time required to reach the required tempeture.
	...
	double t3 = t; // t is the time required to reach the required tempeture.
